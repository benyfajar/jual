...
class PenjualanController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','pilihBarang','formKasir','FormLapPerNota','Laporan1'),
				'users'=>array('@'),
			),
	...
	public function actionFormKasir()
	{
		$modelKasir=new LoginKasir;
		$model=new Penjualan;
		$this->nota = Nota::getNo();
		$this->render('formKasir',array('modelKasir'=>$modelKasir));
	}
	...
	public function actionCreate()
	{
		...
		$model->unsetAttributes();
			...
			$this->render('create',array(
					'model'=>$model,
					'modelBaru'=>$this->newCreate(),
				));
	}
	
	public function newCreate()
	{
		$model=new Penjualan('create');
	...
	public function actionPilihBarang()
	{
		...
		{
			$id=Yii::app()->request->getParam('barang_id');
			$brg=Barang::model()->findByPk($id);
